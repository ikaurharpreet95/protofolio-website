    ...
    <section id="about" className="relative py-24 md:py-32 bg-ivory overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-10 grid lg:grid-cols-2 gap-16 items-center">
        <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.7 }} className="relative">
          ...
          <img src={portrait} alt="Harpreet Kaur, invitation designer" width={800} height={1024} loading="lazy" className="relative rounded-3xl shadow-luxe w-full object-cover aspect-[4/5]" />
        </motion.div>
        ...
        <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.7 }}>
          ...
          <div className="mt-6 space-y-5 text-charcoal/75 leading-relaxed">
            <p>
              Hello! I'm <strong className="text-charcoal">Harpreet Kaur</strong>, a passionate invitation designer with <strong className="text-charcoal">4 months of professional experience</strong> creating memorable invitation designs.
            </p>
            <p>
              Although I am at the beginning of my design journey, I have successfully completed <strong className="text-charcoal">5–7 invitation projects</strong> for happy clients. I believe every celebration deserves an invitation that reflects its unique story.
            </p>
          </div>
